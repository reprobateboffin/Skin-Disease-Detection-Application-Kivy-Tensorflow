...
class MyApp(App):
    def build(self):
        ...
        self.loaded_model = tf.keras.models.load_model(r'C:\Users\muham\Documents\android app Skin disease\Yeni klasör\v3p3100\v3p3100.h5')
        # Create a Label
        self.camera = Camera(resolution=(-1, -1), size_hint=(1, 1))
