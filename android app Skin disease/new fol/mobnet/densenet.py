...
class MyApp(App):
    def build(self):
        ...
        self.loaded_model = tf.keras.models.load_model('./MobNetM.h5')
        # Create a Label
    ...
    def __predict(self):
        ...
        img = cv.resize(cv.imread('./test.jpg'),(100, 100),interpolation=cv.INTER_AREA)
        test = img.reshape((1,100, 100,3))
        test = test/255.0
        # print(test)
